//package info.passdaily.parentapp.typeofuser.parent.gallery.video
//
...
//import info.passdaily.parentapp.R
//import java.util.*
//
...
//     */
//    // Media List
//    private var mediaObjects = ArrayList<VideoActivity.VidModel>()
...
//    }
//
//    private val videoPlayClickListener = OnClickListener {
//        if(playStatus){
//            onPlay()
//        }else{
//            onPausePlayer()
...
//                        Log.i(TAG, "onPlayerStateChanged: Buffering video.")
//                        imageViewPlay!!.bringToFront()
//                        imageViewPlay!!.visibility = VISIBLE
//                        requestManager!!.load(R.drawable.ic_play)
//                            .into(imageViewPlay!!)
//                        if (progressBar != null) {
...
//                    }
//                    Player.STATE_ENDED -> {
//                        Log.i(TAG, "onPlayerStateChanged: Video ended.")
...
//                    }
//                    Player.STATE_READY -> {
//                        Log.i(TAG, "onPlayerStateChanged: Ready to play.")
//                        if (progressBar != null) {
...
//        imageViewPlay = holder.imageViewPlay
...
//        )
//        val mediaUrl = mediaObjects[targetPosition].videoUrl
//        if (mediaUrl != null) {
...
//            imageViewPlay!!.visibility = VISIBLE
////            mLastPosition = videoPlayer!!.currentPosition.toInt()
//            requestManager!!.load(R.drawable.ic_play)
//                .into(imageViewPlay!!)
//            playStatus = true
//        }
...
//    fun onPlay() {
//        if (videoPlayer != null) {
////            videoPlayer!!.seekTo(mLastPosition.toLong());
//            videoPlayer!!.playWhenReady = true
//            videoPlayer!!.playbackState
//            imageViewPlay!!.visibility = GONE
//            playStatus = false
...
//    }
//
//    fun setMediaObjects(mediaObjects: ArrayList<VideoActivity.VidModel>) {
